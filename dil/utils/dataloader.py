...
class ClassAwareSampler(Sampler):
    ...
    def __iter__(self):
        return class_aware_sample_generator(self.class_iter, self.data_iter_list, self.num_samples, self.num_samples_cls, self.is_infinite)
